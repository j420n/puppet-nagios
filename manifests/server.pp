...
class nagios::server (
  ...
  $nagios_server_package_name = hiera(nagios::server::package_name, 'nagios'),
  ...
  package { $nagios_server_package_name: ensure => "installed" }
  ...
  service { $nagios_server_service_name:
    ...
    require   => Package[$nagios_server_package_name],
  }
